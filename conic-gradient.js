...
var _ = self.ConicGradient = function(o) {
	...
	// Add dummy first stop or set first stopâ€™s position to 0 if it doesnâ€™t have one
	...
	// Add dummy last stop or set first stopâ€™s position to 100% if it doesnâ€™t have one
...
_.prototype = {
	...
	paint: function() {
		...
		for (var i = 0; i < 360; i+=.5) {
			...
			if (sameColor) {
				var Î¸ = 360 * (stop.pos - prevStop.pos);
